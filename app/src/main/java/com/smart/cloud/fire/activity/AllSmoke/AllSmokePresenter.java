...
public class AllSmokePresenter extends BasePresenter<AllSmokeView> {
    ...
    public void getSmokeSummary(String userId, String privilege, String parentId, final String areaId, String placeTypeId, String devType, final ShopInfoFragmentView allDevFragment){
